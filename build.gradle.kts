...
buildscript {
    ...
    dependencies {
        classpath("com.android.tools.build:gradle:7.1.2") // resolved in settings.gradle.kts
        classpath("org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.10") // resolved in settings.gradle.kts
    }
}
